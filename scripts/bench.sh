...
if [ "$GPU" = true ]; then
    ...
    echo "    d=64, s=128:"
    print_result "  10 pages (320 vec)" "scores_d64/pages/10"
    print_result "  100 pages (3.2K vec)" "scores_d64/pages/100"
    print_result "  1000 pages (32K vec)" "scores_d64/pages/1000"
    print_result "  10000 pages (320K vec)" "scores_d64/pages/10000"
    echo "    d=128, s=256:"
    print_result "  10 pages (320 vec)" "scores_d128/pages/10"
    print_result "  100 pages (3.2K vec)" "scores_d128/pages/100"
    print_result "  1000 pages (32K vec)" "scores_d128/pages/1000"
    print_result "  10000 pages (320K vec)" "scores_d128/pages/10000"
    echo ""
fi
