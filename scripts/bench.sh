...
echo ""
echo "  Score:"
print_result "score 10 entries (32 vec each)" "score_latency/entries/10"
print_result "score 100 entries" "score_latency/entries/100"
print_result "score 1000 entries" "score_latency/entries/1000"
print_result "score 1 entry (64 vec)" "score_single_entry_64vec"
echo ""
echo "  Compression:"
...
echo ""
echo "  Store I/O:"
print_result "cold start (100 entries)" "cold_start_100_entries"
print_result "append 1 entry" "append_single_entry"
print_result "get_entry lookup" "get_entry_from_100_entries"
echo ""
...
if [ "$GPU" = true ]; then
    ...
    echo "--- GPU Results (32 vec/entry) ---"
    echo ""
    echo "  CPU baseline (sketch.score per entry, never GPU):"
    echo "    d=64, s=128:"
    print_result "  10 entries" "cpu_per_entry_d64/entries/10"
    print_result "  100 entries" "cpu_per_entry_d64/entries/100"
    print_result "  1000 entries" "cpu_per_entry_d64/entries/1000"
    print_result "  10000 entries" "cpu_per_entry_d64/entries/10000"
    echo "    d=128, s=256:"
    print_result "  10 entries" "cpu_per_entry_d128/entries/10"
    print_result "  100 entries" "cpu_per_entry_d128/entries/100"
    print_result "  1000 entries" "cpu_per_entry_d128/entries/1000"
    print_result "  10000 entries" "cpu_per_entry_d128/entries/10000"
    echo ""
    echo "  scores (batched GPU if >= GPU_MIN_BATCH):"
    echo "    d=64, s=128:"
    print_result "  10 entries (320 vec)" "scores_d64/entries/10"
    print_result "  100 entries (3.2K vec)" "scores_d64/entries/100"
    print_result "  1000 entries (32K vec)" "scores_d64/entries/1000"
    print_result "  10000 entries (320K vec)" "scores_d64/entries/10000"
    echo "    d=128, s=256:"
    print_result "  10 entries (320 vec)" "scores_d128/entries/10"
    print_result "  100 entries (3.2K vec)" "scores_d128/entries/100"
    print_result "  1000 entries (32K vec)" "scores_d128/entries/1000"
    print_result "  10000 entries (320K vec)" "scores_d128/entries/10000"
    echo ""
fi
